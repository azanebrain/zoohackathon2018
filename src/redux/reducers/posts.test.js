...
describe('Post Actions', () => {
  ...
  it('should create an action to toggle post active', () => {
    ...
    expect(actions.togglePost(34)).toEqual(expectedAction);
  });
});
